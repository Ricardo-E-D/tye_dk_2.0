<%@ Page Title="" Language="C#" MasterPageFile="~/masterGrand.master" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="login" %>
			...
			<tr>
				<td style="width:50%;">
					<div class="infobox" style="height:320px;width:175px;">
						...
						<div class="buttons">
							<asp:Button ID="lnkCodeLogin" runat="server" Text="login" CssClass="tight btn positive"
								OnClick="eBtnLogin_Click" />
						</div>
						<br />
					</div>
				</td>
					...
					<asp:Panel runat="server" ID="pnlOpticianLogin" DefaultButton="lnkEmailLoginSubmit">
						<div class="infobox" style="height:320px;width:175px;">
							...
							<div class="buttons">
								...
								<asp:Button ID="lnkEmailLoginSubmit" runat="server" Text="login" CssClass="tight btn positive"
									OnClick="ElnkEmailLoginSubmit_Click" />
									<br />
								<asp:LinkButton runat="server" ID="lnkForgotPassword" Text="forgot password?" CssClass="btn positivesmall"
									OnClick="eBtnForgotPasswordSubmit_Click" />
							</div>
							<br /><br /><br />
						</div>
					</asp:Panel>
