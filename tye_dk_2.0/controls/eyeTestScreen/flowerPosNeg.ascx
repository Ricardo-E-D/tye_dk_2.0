<%@ Control Language="C#" AutoEventWireup="true" CodeFile="flowerPosNeg.ascx.cs" Inherits="controls_eyeTestScreen_flowerPosNeg" %>
				...
				<table>
					...
					<tr>
						<td style="text-align: center" valign="middle">
							<img src="/img/eyetest/flowerPosNeg/exp.gif" usemap="#starmap" 
