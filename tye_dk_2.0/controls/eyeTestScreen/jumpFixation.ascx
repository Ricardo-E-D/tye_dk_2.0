<%@ Control Language="C#" AutoEventWireup="true" CodeFile="jumpFixation.ascx.cs" Inherits="controls_eyeTestScreen_jumpFixation" %>
				...
				<table>
					...
					<tr>
						<td style="text-align: center" valign="middle">
							<img src="/img/eyetest/jumpFixation/exp.gif" usemap="#starmap" border="0" width="129" height="130" alt="" />
							<br />
