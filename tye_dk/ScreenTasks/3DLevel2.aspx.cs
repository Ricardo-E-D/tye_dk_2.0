...
{
	public partial class _3DLevel2 : System.Web.UI.Page
	{
		private int intId = -1;
		...
		protected void Page_Load(object sender, System.EventArgs e) {
			...
			btnToBack.Attributes.Add("onclick", "document.location.href = '3DLevel2.aspx?intExerciseIdNo=" + intId.ToString() + "'");
		...
		private void LoadImages()
		{
			...
			script += "imgDir = \"Images/3DLevel2/\";";
			script += "var images = new Array();";
			//DirectoryInfo di = new DirectoryInfo(Attributes.SCREENTASKS_IMAGES+"3DLevel2/");
            DirectoryInfo di = new DirectoryInfo(Request.PhysicalApplicationPath + "/ScreenTasks/Images/3DLevel2/");
