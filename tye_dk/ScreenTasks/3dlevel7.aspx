<%@ Page language="c#" Inherits="tye.ScreenTasks._3DLevel7" CodeFile="3DLevel7.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>3D Level 7 - Blomsten</title>
	...
	<input type="hidden" value="not-negativ" name="test" id="test">
		...
		<map name="starmap">
			<area coords="52,26,75,49" shape="RECT" onclick="DisplayImage('1');" style="CURSOR: pointer" href="#">
