...
{
	public partial class _3DLevel1 : System.Web.UI.Page {
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			btnToBack.Attributes.Add("onclick", "document.location.href = '3DLevel1.aspx?intExerciseIdNo=" + intId.ToString() + "'");
		...
		private void LoadImages()
		{
			...
			script += "imgDir = \"Images/3DLevel1/\";";
			//DirectoryInfo di = new DirectoryInfo(Attributes.SCREENTASKS_IMAGES+"3DLevel1/");
            DirectoryInfo di = new DirectoryInfo(Request.PhysicalApplicationPath + "ScreenTasks/Images/3DLevel1/");
			int counter = 0;
