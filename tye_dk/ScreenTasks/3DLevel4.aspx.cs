...
{
	public partial class _3DLevel4 : System.Web.UI.Page
	{
		private int intId = -1;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			btnToBack.Attributes.Add("onclick", "document.location.href = '3DLevel4.aspx?intExerciseIdNo=" + intId.ToString() + "'");
		...
		private void LoadImages()
		{
			...
			script += "imgDir = \"Images/3DLevel4/\";";
			//DirectoryInfo di = new DirectoryInfo(Attributes.SCREENTASKS_IMAGES+"3DLevel4/");
            DirectoryInfo di = new DirectoryInfo(Request.PhysicalApplicationPath + "/ScreenTasks/Images/3DLevel4/");
			int counter = 0;
