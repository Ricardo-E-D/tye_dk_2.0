<%@ Page language="c#" Inherits="tye.ScreenTasks._3DLevel5" CodeFile="3DLevel5.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>3D Level 5 - Spring fiksering</title>
		...
		<script language="javascript" src="Scripts/3DLevel5.js"></script>
	</HEAD>
				...
				<tr>
					<td valign="middle" align="center">
						<table>
							...
							<tr>
								<td style="TEXT-ALIGN: right" valign="middle"><span id="textGuide" runat="server"></span><img src="Images/3DLevel5/exp.gif" usemap="#starmap" border="0" width="129" height="130"></td>
							</tr>
						</table>
					</td>
				</tr>
