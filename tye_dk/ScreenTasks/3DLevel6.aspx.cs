...
{
	public partial class _3DLevel6 : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			btnToBack.Attributes.Add("onclick", "document.location.href = '3DLevel6.aspx" + (intId > -1 ? "?intExerciseIdNo=" + intId.ToString() : "") + "'");
		...
		private void LoadImages()
		{
			...
			script += "imgDir = \"Images/3DLevel6/\";";
			//DirectoryInfo di = new DirectoryInfo(Attributes.SCREENTASKS_IMAGES+"3DLevel6/");
            DirectoryInfo di = new DirectoryInfo(Request.PhysicalApplicationPath + "ScreenTasks/Images/3DLevel6/");
			int counter = 0;
