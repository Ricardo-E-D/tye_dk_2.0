...
{
	public partial class _3DLevel5 : System.Web.UI.Page
	{
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			btnToBack.Attributes.Add("onclick", "document.location.href = '3DLevel5.aspx" + (intId > -1 ? "?intExerciseIdNo=" + intId.ToString() : "") + "'");
		...
		private void LoadImages()
		{
			...
			script += "imgDir = \"Images/3DLevel5/\";";
            //DirectoryInfo di = new DirectoryInfo(Attributes.SCREENTASKS_IMAGES+"3DLevel5/");
            DirectoryInfo di = new DirectoryInfo(Request.PhysicalApplicationPath + "/ScreenTasks/Images/3DLevel5/");
			int counter = 0;
